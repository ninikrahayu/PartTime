...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard - Partimeku')</title>
...
<body class="bg-surface text-text-dark font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <aside id="sidebar" class="bg-white border-r border-border-color w-64 flex-shrink-0 flex flex-col fixed inset-y-0 left-0 transform -translate-x-full md:sticky md:top-0 md:h-screen md:translate-x-0 z-50 transition-transform duration-300 ease-in-out">
            ...
            <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                @php
                    $menus = [
                        ['url' => 'admin/dashboard', 'icon' => 'fa-solid fa-gauge', 'title' => 'Dashboard'],
                        ['url' => 'admin/verifikasi-akun', 'icon' => 'fa-solid fa-user-check', 'title' => 'Verifikasi Akun'],
                        ['url' => 'admin/verifikasi-lowongan', 'icon' => 'fa-solid fa-file-circle-check', 'title' => 'Verifikasi Lowongan'],
                        ['url' => 'admin/users', 'icon' => 'fa-solid fa-users', 'title' => 'Manajemen Pengguna'],
                        ['url' => 'admin/categories', 'icon' => 'fa-solid fa-tags', 'title' => 'Manajemen Kategori'],
                        ['url' => 'admin/jobs', 'icon' => 'fa-solid fa-briefcase', 'title' => 'Manajemen Lowongan'],
                        ['url' => 'admin/applications', 'icon' => 'fa-solid fa-file-lines', 'title' => 'Manajemen Lamaran'],
                        ['url' => 'admin/reports', 'icon' => 'fa-solid fa-chart-pie', 'title' => 'Laporan'],
                        ['url' => 'admin/profile', 'icon' => 'fa-solid fa-user-gear', 'title' => 'Profil'],
                    ];
                @endphp
    ...
    <script>
        ...
        function approveDummy(message) {
            showToast(message || 'Data berhasil disetujui.', 'success');
        }

        function rejectDummy(modalId, message) {
            closeModal(modalId);
            showToast(message || 'Data berhasil ditolak.', 'danger');
        }
    </script>
    @stack('scripts')
</body>
